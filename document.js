...
');
        ...
        if (this.options.editable) {
            if (edit_mode === 1 && window.top === window.self)
                eval('(function(){"use strict";function t(){function t(){$DOC.cbody.attachAll(),$DOC.appendCSS("document.editor.css",".tooltip, .popover { z-index:1200; }"),b=new a,$DOC.cbody.add(y=new i),y.createElement(),f=$DOC.cbody.add("div",{style:"overflow:hidden; border-radius:4px; position:fixed; top:20px;bottom:20px;right:20px; height:50%; width:50%; z-index:1101; border: silver solid 1px; background-color:white;"}),m=f.add("toolbar:div",{"class":"clearfix",style:"z-index:1111; background-color:#f0f0f0; line-height:32px; padding:0;"}).listen("element",function(t){t&&$(t).find("button,li,a").tooltip({placement:"bottom",container:"body",toggle:"tooltip"})}),m.add("save_group:bootstrap.BtnGroup",{"class":"mar5"},function(t){function e(){t.download.element.href=(window.navigator.appName.indexOf("etscape")>0?"data:unknown":"data:application")+"/octet-stream;charset=utf-8,"+encodeURIComponent(h.buildHTML())}t.add("revert:bootstrap.Button",{$icon:"backward","data-original-title":"Revert to saved state"}).listen("click",function(){h.revert()}),t.add("download:a",{download:decodeURI(location.pathname).split("/").slice(-1)[0]||"document.html","class":"btn btn-default",$text:\'<b class="glyphicon glyphicon-save"></b>\',"data-original-title":"Download edited document"}).listen("mousedown",e).listen("focus",e).listen("click",function(t){try{var e=new Blob([h.buildHTML()]);return window.navigator.msSaveOrOpenBlob(e,decodeURI(location.pathname).split("/").slice(-1)[0]||"document.html"),t.preventDefault(),void 0}catch(n){}}),t.add("save:bootstrap.Button",{"class":"btn btn-default hide",$icon:"edit","data-original-title":"Save"}).listen("click",function(){h.save(),u.writePage(decodeURI(window.location.pathname),h.buildHTML())})}),m.add("controls_group:bootstrap.BtnGroup",{"class":"mar5 fright"},function(t){t.add("bootstrap.Button",{$icon:"fullscreen","data-original-title":"Over-nonoverlapped"}).listen("click",function(){h.mode=h.mode?0:1}),t.add("bootstrap.Button",{$icon:"th-large","data-original-title":"Left-right-top-bottom"}).listen("click",function(){h.position++,h.position>3&&(h.position=0)}),t.add("bootstrap.Button",{$icon:"remove","data-original-title":"Close editor (Ctrl-F12)"}).listen("click",function(){var t=location.href,e=t.lastIndexOf("edit"),n=4;"?"===t[e-1]&&(e--,n++),window.location=t.slice(0,e)+t.slice(e+n)})}),m.add(p=new o),f.add(v=new n),f.add(g=new e),f.createElement(),h=new s,u=new r}$(window).load(function(){c=new l(location.origin+location.pathname,t)})}function e(){var t=controls.create("div",{"class":"pad20"}),e=!0;Object.defineProperty(t,"visible",{get:function(){return e},set:function(n){e=n,t.element&&(t.element.style.display=e?"block":"none")}}),t.listen("element",function(t){t&&(t.style.display=e?"block":"none")});var n=t.add("bootstrap.FormGroup");return n.add("bootstrap.ControlLabel",{$text:"Title:"}),n.add("title_edit:bootstrap.ControlInput",{value:""}).listen("change",function(){b.title=n.title_edit.value}),b.listen(function(){b.title!==n.title_edit.value&&(n.title_edit.value=b.title)}),t.save=function(){},t}function n(){function t(){if(e.mode){var t=e._element;t&&t.value!==o&&(e.modified=25,o=t.value)}}var e=controls.create("textarea",{"class":"form-control",style:"font-family:Consolas,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New,monospace; display:none; border:0; border-radius:0; border-left:#f9f9f9 solid 6px; box-shadow:none; width:100%; height:100%; resize:none; "});e.code_edit_resize=function(){e.element.style.height=$(f.element).height()-$(m.element).height()+"px"},$(window).on("resize",e.code_edit_resize);var n=0;Object.defineProperty(e,"mode",{get:function(){return n},set:function(t){t>2&&(t=2),t!==n&&(n=t,this.element&&(e.element.style.display=n?"block":"none"),e.code_edit_resize())}});var o;return e.listen("element",function(t){t&&(t.value=o),e.code_edit_resize()}),Object.defineProperty(e,"text",{get:function(){return this.element?this.element.value:o},set:function(t){o=t||"",this.element&&(this.element.value=o),this.modified=0}}),e.save=function(){t(),this.modified&&(this.modified=0,this.raise("text",o))},e.listen("change",t,!0),setInterval(function(){t(),e.modified&&--e.modified<2&&(e.modified=0,e.raise("text",o))},25),e}function o(){function t(){i.selectedIndex=i.controls.indexOf(this)}var e,n,o=-1,i=m.add("tabs_header:bootstrap.TabPanelHeader");return i.bind(controls.create("dataarray")),i.data.push({isoptions:!0,text:"",hint:"Page options",icon:"list-alt"},{ishtml:!0,text:"HTML",hint:"Edit as HTML"}),i.setTabs=function(t){var e=p.data;t.length+2<e.length&&e.splice(1,e.length-t.length-2);for(var n=e.length,o=t.length+2;o>n;n++)e.splice(1,0,{});for(var n=1,i=e.length-1;i>n;n++)e[n].text=t[n-1];e.raise()},i.listen("data",function(){for(var n=i.controls,o=this.data,a=n.length,s=o.length;s>a;a++)i.add("bootstrap.TabHeader").listen("click",t);for(var a=n.length-1,s=o.length;a>=s;a--){var r=n[a];r.deleteAll(),r.removeListener("click",t),i.remove(r)}for(var a=0,s=o.length;s>a;a++){var l=o[a];l.id=n[a].id;var r=n[a];r.attributes["data-original-title"]=l.hint,r.attributes.$icon=l.icon,r.text(l.text),l===e?r.class("active"):r.class(null,"active")}i.checkSelection(),i.element&&i.refresh()}),Object.defineProperty(i,"selectedIndex",{get:function(){return o},set:function(t){this.selected=t}}),Object.defineProperty(i,"selected",{get:function(){return e},set:function(t){var i=this.data;if("string"!=typeof t){if("number"==typeof t)return t>=0&&t<i.length&&t!==o?this.selected=i[t]:-1===t&&(this.selected=void 0),void 0;var a=i.indexOf(t);if(a>=0){var s=i[a];s!==e&&(n=e)}if(t!==e||a!==o){for(var r=this.controls,l=0,d=r.length;d>l;l++)l===a?r[l].class("active"):r[l].class(null,"active");this.raise("selected",e=t?t:void 0,o=a)}}else{for(var l=0,d=i.length;d>l;l++){var s=i[l];if(s.id===t)return this.selected=s,void 0}for(var l=0,d=i.length;d>l;l++){var s=i[l];if(s.text===t)return this.selected=s,void 0}}}}),i.checkSelection=function(){var t=this.data;t.length?(!e||0>o||o>=t.length)&&(this.selected=n,e||(i.selectedIndex=!o||0>o?0:t.length-1)):(o>=0||e)&&(this.selected=-1)},i}function i(){var t,e,n=location.href;return n=n.slice(0,n.length-location.hash.length),n+=n.indexOf("?")>0?"&preview":"?preview",y=controls.create("iframe",{sandbox:"",src:n,style:"position:fixed; left:0; top:0; width:100%; height:100%; z-index:1100; border:none;"}),y.updateInnerHtml=function(n,o){t=n,e=o;var i=this.element&&this.element.contentDocument,a=this.$DOC;if(i&&a){var s=i.getElementsByTagName("html")[0];s&&(a.initialize(),s.innerHTML=n,a.headTransformation(),a.options.userjs?a.loadUserJS():setTimeout(function(){a.finalTransformation()},0))}},y.reload=function(){this.element&&this.deleteAll(),this.createElement()},y.listen("load",function(){setTimeout(function(){try{this.element.contentWindow.location.pathname!==window.location.pathname&&this.reload()}catch(n){this.reload()}this.$DOC=this.element&&y.element.contentWindow.$DOC,void 0!==t&&this.updateInnerHtml(t,e)}.bind(y),0)}),y.updateNamedSection=function(e,n,o){t=o;var i=this.$DOC,a=i.sections[e];"object"==typeof a&&a.source_node&&i.processTextNode(a.source_node,e+"\\n"+n)},y}function a(){function t(){return(this.opentag||"")+(this.attributes.$text||"")+this.controls.map(function(t){return t.outerHTML()}).join("")+(this.closetag||"")}var e,n,o,i;Object.defineProperty(this,"title",{get:function(){return o},set:function(a){if(o=a,!i){if(!n)return;i=n.add("div"),i.template(t)}i.controls.length=0,i.opentag="<title>"+a+"</title>",i.closetag="",e=this.buildHTML(),this.raise()}}),Object.defineProperty(this,"html",{get:function(){return e},set:function(a){if(a!==e){e=a;var s={},r={},l=document.implementation.createHTMLDocument(""),d=l.documentElement;d.innerHTML=/<html[\\s\\S]*?>([\\s\\S]*)<\\/html>/im.exec(e)[1];for(var c=controls.create("div"),u=[],h=[],f=l.createNodeIterator(d,65535,null,!1),m=f.nextNode();m;){var p=m===d?c:controls.create("div");p.template(t),u.push(m),h.push(p);var g=u.indexOf(m.parentNode);if(g>=0&&h[g].add(p),8===m.nodeType){var v=m.nodeValue,b=v[0];if(p.opentag="<!--"+m.nodeValue+"-->","%"===b);else if("!"===b);else{var y=v.indexOf(" "),w=v.indexOf("\\n"),x=v.indexOf("->");if(0>y&&0>w&&0>x);else if(0>y&&x>0);else if(w>0&&(0>y||y>w)&&(y=w),y>0&&128>y){var T=v.slice(0,y);s[T]=v.slice(y+1),r[T]=p}}}else if(m===d)p.opentag="<!DOCTYPE html>\\n"+/(<html[\\s\\S]*?>)[\\s\\S]*?<head/im.exec(e)[1]+"\\n",p.closetag="\\n</html>";else{var O=m.outerHTML,k=m.innerHTML;if(k){var S=O.lastIndexOf(k);0>S?p.opentag=O:(p.opentag=O.slice(0,S),p.closetag=O.slice(S+k.length))}else p.opentag=O?O:m.nodeValue}m=f.nextNode()}var E=l.getElementsByTagName("head")[0];n=E&&h[u.indexOf(E)];var L=l.getElementsByTagName("title")[0];L?(o=L.textContent,i=h[u.indexOf(L)]):(o="",i=null),this.chtml=c,this.sections=s,this.seccontrols=r,this.raise()}}}),this.updateNamedSection=function(t,n){var o=this.seccontrols[t];o&&(this.sections[t]=n,o.opentag="<!--"+t+"\\n"+n+"-->\\n",e=this.chtml.outerHTML())},this.buildHTML=function(){return this.chtml.outerHTML()}}function s(){function t(){if(o)switch(i){case 1:controls.extend(y.element.style,{width:"100%",height:"100%"}),controls.extend(f.element.style,{top:"20px",bottom:"auto",left:"20px",right:"auto",width:"50%",height:"50%"});break;case 2:controls.extend(y.element.style,{width:"100%",height:"100%"}),controls.extend(f.element.style,{top:"auto",bottom:"20px",left:"20px",right:"auto",width:"50%",height:"50%"});break;case 3:controls.extend(y.element.style,{width:"100%",height:"100%"}),controls.extend(f.element.style,{top:"auto",bottom:"20px",left:"auto",right:"20px",width:"50%",height:"50%"});break;default:controls.extend(y.element.style,{width:"100%",height:"100%"}),controls.extend(f.element.style,{top:"20px",bottom:"auto",left:"auto",right:"20px",width:"50%",height:"50%"})}else switch(i){case 1:controls.extend(y.element.style,{top:"0",right:"0",bottom:"0",left:"auto",width:"50%",height:"100%"}),controls.extend(f.element.style,{top:"0",right:"auto",bottom:"0",left:"0",width:"50%",height:"100%"});break;case 2:controls.extend(y.element.style,{top:"auto",right:"0",bottom:"0",left:"0",width:"100%",height:"50%"}),controls.extend(f.element.style,{top:"0",right:"0",bottom:"auto",left:"0",width:"100%",height:"50%"});break;case 3:controls.extend(y.element.style,{top:"0",right:"0",bottom:"auto",left:"0",width:"100%",height:"50%"}),controls.extend(f.element.style,{top:"auto",right:"0",bottom:"0",left:"0",width:"100%",height:"50%"});break;default:controls.extend(y.element.style,{top:"0",right:"auto",bottom:"0",left:"0",width:"50%",height:"100%"}),controls.extend(f.element.style,{top:"0",right:"0",bottom:"0",left:"auto",width:"50%",height:"100%"})}v.code_edit_resize()}var e;b.listen(function(){h.edit_html=b.html,p.setTabs(Object.keys(b.sections)),y.updateInnerHtml(b.chtml.innerHTML(),Object.keys(b.sections))});var n;Object.defineProperty(this,"edit_html",{get:function(){return n},set:function(t){t!==n&&(n=t,b.html=n)}}),this.checkEdits=function(){var t=p.selected;t&&t.isoptions?g.save():t&&v.save()},p.listen("selected",this,function(){this.checkEdits(),this.updateCodeEdit(),this.modified=5,g.visible=0===p.selectedIndex}),this.updateCodeEdit=function(){var t=p.selected;switch(v.mode=!t||t.isoptions?0:t.ishtml?1:2,v.mode){case 1:v.text=h.edit_html;break;case 2:var e=p.selected;e?(v.section=e.text,v.text=b.sections[e.text]):v.text="";break;default:v.text=""}},v.listen("text",function(t){switch(v.mode){case 1:h.edit_html=t,h.modified=25;break;case 2:h.updateNamedSection(v.section,v.text),h.modified=25}}),this.updateNamedSection=function(t,e){b.updateNamedSection(t,e),n=b.buildHTML(),y.updateNamedSection(t,e,b.chtml.innerHTML())},this.save=function(){this.checkEdits();var t=c.dataobject.data;t.selected=p.selected&&p.selected.text,t.html=this.edit_html,t.html===e&&(t.delete=!0),c.dataobject.raise(),this.modified=0},this.revert=function(){this.edit_html=e,this.updateCodeEdit(),this.modified=2,setTimeout(function(){window.location.reload()},300)},this.buildHTML=function(){return v.save(),b.buildHTML()};var o=0,i=0,a=600,s=500;if(Object.defineProperty(this,"mode",{get:function(){return o},set:function(e){o=e,t(),h.saveLayout()}}),Object.defineProperty(this,"position",{get:function(){return i},set:function(e){i=e,t(),h.saveLayout()}}),this.saveLayout=function(){"undefined"!=typeof localStorage&&localStorage.setItem("editor layout",[o,i,a,s].join(";"))},"undefined"!=typeof localStorage){try{var r=localStorage.getItem("editor layout").split(";");o=parseInt(r[0]),i=parseInt(r[1]),a=parseInt(r[2]),s=parseInt(r[3])}catch(l){}t()}c.restore(function(){var t=new XMLHttpRequest;t.open("GET",location.href,!1),t.onload=function(t){e=t.target.response.replace(/\\r/g,""),h.edit_html=c.dataobject.data.html||e,setTimeout(function(){p.selected=c.dataobject.data.selected||p.data[0]},100),p.checkSelection()},t.send()}),setInterval(function(){this.modified&&--this.modified<2&&(this.modified=0,this.save())}.bind(this),25)}function r(){var t,e,n;if("file:"!==location.protocol){var o=location.href,i=o.lastIndexOf("/");t=(0>i?o:o.slice(0,i))+"/@",e=o.slice(i+1)}this.writePage=function(e,n){t&&$.ajax({url:t,type:"POST",dataType:"json",contentType:"application/json; charset=UTF-8",async:0,data:JSON.stringify({command:"write",url:e,data:n})}).done(function(t){"success"===t.result&&c.reloadOnReady()})},t&&$.ajax({url:t,type:"POST",dataType:"json",contentType:"application/json; charset=UTF-8",data:JSON.stringify({command:"options"})}).done(function(t){"success"===t.result?(n=t,n.editable&&m.save_group.save.class(null,"hide")):n=void 0})}function l(t,e){function n(){d(\'<h4><b class="glyphicon glyphicon-warning-sign">&nbsp;</b>Editor loading error</h4>Your browser does not supported and can not be used to edit documents. Please use Firefox, Chrome, Opera or Safari.\')}var o,i,a,s,r=this,l=r.dataobject=controls.create("DataObject");if(l.data={key:t,history:[]},l.listen(function(){o=!0}),setInterval(function(){o&&r.write()},25),window.indexedDB){try{var c=window.indexedDB.open("markdown-webdocs.editor.db",1);c.onsuccess=function(t){i=t.target.result,e()},c.onupgradeneeded=function(t){i=t.target.result,i.createObjectStore("drafts",{keyPath:"key"}),e()},c.onerror=function(t){d(\'<h4><b class="glyphicon glyphicon-warning-sign">&nbsp;</b>Editor loading error</h4>Database error. Please try using another browser for editing the document.\'),console.log(t)},c.onblocked=function(t){d(\'<h4><b class="glyphicon glyphicon-warning-sign">&nbsp;</b>Editor loading error</h4>Database blocked\'),console.log(t)}}catch(u){return n(),void 0}r.restore=function(e){try{var n=i.transaction(["drafts"],"readonly").objectStore("drafts").get(t);n.onsuccess=function(n){var i=l.data;controls.extend(i,n.target.result),i.key=t,Array.isArray(i.history)||(i.history=[]),s=!0,o=!1,e&&e()},n.onerror=function(t){console.log(t)}}catch(a){}},r.write=function(){if(s)try{var e=i.transaction(["drafts"],"readwrite").objectStore("drafts"),n=l.data;n.delete?(delete n.delete,e.delete(t)):e.put(n),o=!1}catch(a){console.log(a)}}}else{if(!window.openDatabase)return n(),void 0;try{var a=window.openDatabase("markdown-webdocs.editor.db","1.0","markdow webdocs drafts",0);if(!a)return n(),void 0;a.transaction(function(t){t.executeSql("CREATE TABLE IF NOT EXISTS drafts (key TEXT NOT NULL PRIMARY KEY, value TEXT)",[],null,n)},n,e)}catch(u){return n(),void 0}r.restore=function(e){try{a.transaction(function(n){n.executeSql("SELECT value FROM drafts WHERE key = ? LIMIT 1",[t],function(t,n){var i=l.data;if(n.rows.length)try{controls.extend(i,JSON.parse(n.rows.item(0).value))}catch(a){}Array.isArray(i.history)||(i.history=[]),s=!0,o=!1,e&&e()},function(t){console.log(t)})},function(){console.log(event)},function(){})}catch(n){}},r.write=function(){if(s)try{a.transaction(function(e){var n=l.data;n.delete?(delete n.delete,e.executeSql("DELETE FROM drafts WHERE key = ?",[t],function(){},function(t){console.log(t)})):e.executeSql("INSERT OR REPLACE INTO drafts (key, value) VALUES (?, ?)",[t,JSON.stringify(n)],function(){},function(t){console.log(t)})},function(){console.log(event)},function(){}),o=!1}catch(e){console.log(e)}}}r.reloadOnReady=function(){setTimeout(function(){location.reload()},400)}}function d(t){$DOC.cbody.attachAll(),$DOC.cbody.unshift("alert:div",{$text:t,"class":"mar20 alert alert-warning col1-sm-offset-3 col-sm-6",style:"z-index:1200;"}),$DOC.cbody.alert.createElement()}var c,u,h,f,m,p,g,v,b,y;this.top!==this.self||this["mw-document-editor"]||(this["mw-document-editor"]=!0,"undefined"!=typeof $ENV?t():(this.defercqueue||(this.defercqueue=[]),this.defercqueue.push(t)),a.prototype=controls.create("DataObject"))}).call(function(){return this||("undefined"!=typeof window?window:global)}());');
...
},{"./temp/bootstrap.controls.js":2,"./temp/marked":3,"controls":4,"dot":8}],2:[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};//     controls.bootstrap.js
...
},{"dot":6}],5:[function(require,module,exports){
// doT.js
...
},{"./doT":5,"fs":9}],7:[function(require,module,exports){
module.exports=require(5)
},{}],8:[function(require,module,exports){
module.exports=require(6)
},{"./doT":7,"fs":9}],9:[function(require,module,exports){
